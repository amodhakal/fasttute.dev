...
export function LandingPage() {
  ...
  return (
    <main className="bg-[#0a0a0a] min-h-[95vh] w-full flex items-center justify-center p-4 text-neutral-200 relative overflow-hidden">
      <div
      ...
      <div className="w-full max-w-3xl mx-auto flex flex-col items-center text-center relative z-10 gap-y-12">
        <div className="flex flex-col items-center gap-y-6">
          <h1
            className={
              "text-3xl sm:text-5xl md:text-7xl font-bold tracking-tighter leading-tight text-white [text-shadow:0_4px_20px_rgba(0,0,0,0.5)] " +
              pollerOne.className
            }
          >
            Stop scrubbing.
